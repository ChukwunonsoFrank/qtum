            ...
            <form class="from-login" method="post" novalidate="">
                ...
                <div class="middle-from">
                    <fieldset class="mb-12 icon-absolute">
                        <i class="icon-user"></i>
                        <input type="text" name="name" id="id_name" placeholder="Fullname" required>
                    </fieldset>
                    <fieldset class="mb-12 icon-absolute">
                        <i class="icon-mail"></i>
                    ...
                    <fieldset class="category-select mb-12">
                        <div class="default-select icon-absolute">
                            ...
                            <select name="country" id="country">
                                <option value="" selected="selected" style="color: #fff !important;">
                                    Select
                                    Country</option>
                    ...
                    <fieldset class="box-auth-pass mb-12 tf-field icon-absolute">
                        <i class="icon-lock"></i>
                        <input type="password" name="" placeholder="Confirm Password" id="id_email-rawPassword"
                            class="password-field" required>
                        <span class="show-pass">
                            <span class="icon-eye"></span>
                            <span class="icon-eye-off"></span>
