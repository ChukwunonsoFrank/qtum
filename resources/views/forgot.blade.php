...
<head>
        ...
        <meta name="csrf-token" content="o5RCleofpyeJ7TYbkb9XMVOg67XuVvziP1dK038Y">
        <title>XLMLOBSTR | Forgot your password</title>


        <link rel="icon" href="storage/app/public/photos/upload-favicon.png1617293031" type="image/png"/>
                ...
                <div class="col-12 col-md-6 col-lg-6 col-sm-10 col-xl-6">
                    ...
                    <div class="bg-white shadow card login-page roundedd border-1 ">
                        <div class="card-body">
                            ...
                            <form method="POST" action="https://www.xlmlobstrledger.com/app/forgot-password"  class="mt-4 login-form">
                                 <input type="hidden" name="_token" value="o5RCleofpyeJ7TYbkb9XMVOg67XuVvziP1dK038Y">                                <div class="row">
                                    <div class="col-lg-12">
                                    ...
                                    <div class="text-center col-12">
                                        <p class="mt-4 mb-0"><small class="mr-2 text-dark">&copy; Copyright  2023 &nbsp; XLMLOBSTR &nbsp; All Rights Reserved.</small>
                                        </p>
                                    </div>
                                </div>
                                <!--end row-->
