                            ...
                            <tr>
                                <td align="center" valign="top">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                        class="tableCard" style="background-color:#fff;">
                                        <tbody>
                                            <tr>
                                            ...
                                            <tr>
                                                <td style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;"
                                                    ...
                                                    <h2 class="text"
                                                        style="color:#FE4543;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:28px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:36px;text-transform:none;text-align:center;padding:0;margin:0">
                                                        Sent</h2>
                                                </td>
                                            </tr>
                                            {{--                            <tr> --}}
                                            ...
                                            <tr>
                                                <td style="padding-left:20px;padding-right:20px" align="center"
                                                    ...
                                                    <table border="0" cellpadding="0" cellspacing="0" width="100%"
                                                        ...
                                                        <tbody>
                                                            <tr>
                                                                <td style="padding-bottom: 20px;" alignx="center"
                                                                    valign="top" class="description">
                                                                    <p class="text"
                                                                        style="color:black;font-size:20px;font-weight:100;font-style:normal;letter-spacing:normal;line-height:22px;text-transform:none;padding:0;margin:0">
                                                                        Your transfer of
                                                                        {{ $data->amount }}
                                                                        {{ strtoupper($data->asset) }} from your wallet
                                                                        was successful.
                                                                    </p>
                                                                </td>
                                                            </tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td style="padding: 0px 10px 10px;" align="center" valign="top"
                                                    ...
                                                    <p class="text"
                                                        style="color:#bbb;font-size:12px;font-weight:400;font-style:normal;letter-spacing:normal;line-height:20px;text-transform:none;text-align:center;padding:0;margin:0">
                                                        Don’t recognize this activity? Please reset your password and
                                                        contact the costumer support immediately, <a
                                                            href="mailto:support@qtumweb3.net"
                                                            style="color:#bbb;text-decoration:underline"
                                                            target="_blank">Support@qtumweb3.net</a>
