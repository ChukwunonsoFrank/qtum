                                        ...
                                        <img alt="" border="0" src="https://quantumsurgeledger.com/assets/logo.png">
                                                        ...
                                                        <tr>
                                                            <td style="padding-bottom: 5px; padding-left: 20px; padding-right: 20px;" align="center" valign="top" class="mainTitle">
                                                                <h2 class="text" style="color:#000;font-family:Poppins,Helvetica,Arial,sans-serif;font-size:28px;font-weight:500;font-style:normal;letter-spacing:normal;line-height:36px;text-transform:none;text-align:center;padding:0;margin:0">Deposit Successful</h2>
                                                            </td>
                                                        </tr>
{{--                                                        <tr>--}}
                                        ...
                                        <tr>
                                            <td style="padding-bottom: 20px;" alignx="center" valign="top" class="description">
                                                <p class="text" style="color:black;font-size:20px;font-weight:100;font-style:normal;letter-spacing:normal;line-height:22px;text-transform:none;padding:0;margin:0">
                                                    Your deposit of {{$data->amount}} {{strtoupper($data->coin)}} is now available in your ledger account.
                                                    <br> <br>
