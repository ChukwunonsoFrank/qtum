        ...
        <div class="tf-container position-relative">
                ...
                <div class="right">
                    <div class="d-flex align-items-center gap-2">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none"
                            ...
                            <g clip-path="url(#clip0_45_2)">
                                <path
                                    ...
                                    stroke="#75BDA7" stroke-width="1.33333" stroke-linecap="round"
                        ...
                        <span class="text fw-5 text-medium"
                            style="color: #75BDA7 !important; font-weight: bold;">Connected</span>
                    </div>
                </div>
            </div>
            ...
            <div class="card-payment mb-24">
                ...
                <div class="bottom-card">
                    <div class="left">
                        <span class="text-medium fw-5"></span>
                    </div>
                    <div class="right">
                        <a href="{{ url('app/stake/initiate') }}" class="btn-my-report">
                            <span>Stake</span>
                            <div class="icon"><i class="icon-direction-right"></i></div>
                        </a>
                    </div>
                </div>
            </div>
        ...
        <div class="wg-transaction-history">
            <div class="tf-container">
                <div class="d-flex justify-content-between align-items-center mb-16 heading-wg">
                    <h6 class="title fw-6">Earning tokens</h6>
                </div>
                @if ($stakes->count())
                    <ul class="list">
                        @foreach ($stakes as $s)
                            <li>
                                <a href="#" class="box-transaction-item style-icon">
                                    <div class="icon">
                                        <img src="{{ asset($s->asset->img) }}" alt="" srcset="">
                                    </div>
                                    <div class="content">
                                        <div class="top d-flex justify-content-between align-items-center">
                                            <p class="name fw-6">{{ $s->asset->name }}</p>
                                            <p class="price fw-5">{{ $s->amount }} {{ $s->asset->name }}</p>
                                        </div>
                                        <div class="bottom d-flex justify-content-between align-items-center">
                                            <p class="text-medium">Expected Duration: {{ $s->duration }} Months</p>
                                            <p class="text-medium">
                                                {{ $s->apr_rate }}% APR
                                            </p>
                                        </div>
                ...
                @else
                    <div class="text-center py-5">
                        ...
                        <p class="text-medium mt-3">No stakes yet</p>
                        <p class="text-small text-muted">Your staking history will appear here</p>
                    </div>
                @endif
            </div>
        </div>
