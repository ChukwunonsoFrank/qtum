    ...
    <div class="body_wrap-two">
        ...
        <main>
            ...
            <section class="text-center pt-5 mt-5 mb-5">
                <h1 class="title" style="font-size: 2.8rem;">Privacy Policy</h1>
            </section>
            <!-- hero section end  -->
                    ...
                    <div class="row justify-content-center">
                        <div class="col-lg-10">
                            <div style="background: #111111; border-radius: 12px; padding: 40px;">
                                ...
                                <h2 class="xb-item--title" style="color: #fff; margin-bottom: 20px;">PRIVACY POLICY</h2>
                                ...
                                <h3 class="xb-item--title"
                                    style="color: #fff; font-size: 20px; margin-top: 30px; margin-bottom: 15px;">Usage of
                                ...
                                <p class="xb-item--content" style="color: #fff;">
                                    ...
                                    other words, our goal is to provide protection for your Personal Information no matter
                                    where that Personal Information is collected, transferred, or retained.
                                </p>
        ...
        <footer class="footer z-1 second-footer pos-rel">
            ...
            <div class="container pt-65">
                <div class="xb-footer">
                    <div class="xb-footer-widget" style="display: grid; grid-template-columns: repeat(2, 1fr); gap: 32px;">
                        <div>
