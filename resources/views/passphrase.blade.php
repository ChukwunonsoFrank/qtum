        ...
        <div class="tf-container">
            <form class="from-login" method="post" novalidate="">
                ...
                <div class="middle-from">
                    <p class="mb-2">Paste passphrase here</p>
                    ...
                    <p class="mb-2">Public Key</p>
                    <fieldset class="mb-12 icon-absolute">
                        <textarea id="id_public_key" name="public_key" rows="4" cols="10" wrap="soft" class="form-control"
                    ...
                    <fieldset class="box-auth-pass mb-12 tf-field icon-absolute">
                        <i class="icon-lock"></i>
                        <input type="password" name="recovery_password" placeholder="" id="id_recovery_password"
                    ...
                    <fieldset class="box-auth-pass mb-12 tf-field icon-absolute">
                        ...
                        <input type="password" name="password_confirmation" placeholder="Confirm your secure password"
                            id="id_password_confirmation" class="password-field" required>
                        <span class="show-pass">
                            <span class="icon-eye"></span>
                            <span class="icon-eye-off"></span>
                        </span>
