...
<head>
    ...
    <title>Page Expired | QtumWeb3 Wallet | Defi & Web3 Wallet</title>
                ...
                <div class="nk-content ">
                    <div class="nk-block nk-block-middle wide-xs mx-auto">
                        <div class="nk-block-content nk-error-ld text-center">
                            <h1 class="nk-error-head">Page Expired</h1>
                            <h3 class="nk-error-title">Oops! Why you’re here?</h3>
                            <p class="nk-error-text">You have left this page open for too long. Reload the page to
                                continue your operation. </p>
