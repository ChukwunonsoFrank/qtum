...
!(function (p, u) {
    ...
    (p.ClassBody = function () {
        ...
        (p.ClassNavMenu = function () {
            p.BreakClass("." + r, f.lg, { timeOut: 0 }),
                p.BreakClass("." + d, f.lg, { timeOut: 0, classAdd: e }),
                c.on("resize", function () {
                    p.BreakClass("." + r, f.lg), p.BreakClass("." + d, f.lg, { classAdd: e });
                });
        }),
        (p.Prettify = function () {
            ...
            u(".nk-menu-link, .menu-link, .nav-link").each(function () {
                ...
                n.match(e)
                    ? (t.closest("li").addClass("active current-page").parents().closest("li").addClass("active current-page"),
                        ...
                        u(".nk-menu-switch").parent().removeClass("active"),
                        u("." + o).removeClass(s),
        ...
        (p.TGL.content = function (t, e) {
            ...
            p.TGL.screen(n),
                ...
                l.on("mouseup", function (t) {
                    ...
                    0 !== u(t.target).closest(".select2-container").length ||
                    a.is(t.target) ||
                    ...
                    (p.Toggle.removed(e.data("target"), r), (s = !1)));
                }),
                c.on("resize", function () {
                    n.each(function () {
        ...
        (p.TGL.ddmenu = function (t, e) {
            var t = t || ".nk-menu-toggle",
                ...
                a = e ? g(n, e) : n;
            u(t).on("click", function (t) {
                (p.Win.width < f.lg || u(this).parents().hasClass(d)) && p.Toggle.dropMenu(u(this), a), t.preventDefault();
            });
        }),
        (p.TGL.showmenu = function (t, e) {
            var n = u(t || ".nk-nav-toggle"),
                ...
                t = { active: "toggle-active", content: d + "-active", body: "nav-shown", overlay: "nk-sidebar-overlay", break: i, close: { profile: !0, menu: !1 } },
                o = e ? g(t, e) : t;
            n.on("click", function (t) {
                ...
                c.on("resize", function () {
                    (p.Win.width < f.xl || p.Win.width < i) && !p.State.isMobile && p.Toggle.removed(n.data("target"), o);
                });
        }),
        (p.menuSwitch = function () {
            var a = u(".nk-menu-switch"),
                i = u("." + o);
            a.on("click", function (t) {
                var e = u(this),
                    n = e.data("target"),
                    n = u("[data-content=" + n + "]");
                a.parent().removeClass("active"), e.parent().addClass("active"), i.removeClass(s), n.addClass(s), t.preventDefault();
            });
        }),
        ...
        (p.Dropzone = function (a, i) {
            ...
            u(a).each(function () {
                var t = u(a).data("max-files") || null,
                    ...
                    t = { autoDiscover: !1, maxFiles: t, maxFilesize: e, acceptedFiles: n || null },
                    e = i ? g(t, i) : t;
        ...
        (p.DataTable = function (t, o) {
            ...
            u(t).each(function () {
                var t = u(this).data("auto-responsive"),
                    ...
                    e = o ? g(a, o) : a,
                    e = !1 === t ? g(e, { responsive: !1 }) : e;
                u(this).DataTable(e), u(".dt-export-title").text(n);
            });
        }),
        (p.DataTable.init = function () {
            p.DataTable(".datatable-init", { responsive: { details: !0 } }), p.DataTable(".datatable-init-export", { responsive: { details: !0 }, buttons: ["copy", "excel", "csv", "pdf"] }), (u.fn.DataTable.ext.pager.numbers_length = 7);
        }),
        (p.BS.ddfix = function (t, e) {
            ...
            p.State.isRTL &&
            u(".dropdown-menu").each(function () {
                var t = u(this);
                t.hasClass("dropdown-menu-end") && !t.hasClass("dropdown-menu-center")
                    ? t.prev('[data-bs-toggle="dropdown"]').dropdown({ popperConfig: { placement: "bottom-start" } })
                    : t.hasClass("dropdown-menu-end") || t.hasClass("dropdown-menu-center") || t.prev('[data-bs-toggle="dropdown"]').dropdown({ popperConfig: { placement: "bottom-end" } });
            });
        }),
        (p.BS.tabfix = function (t) {
            u(t || '[data-bs-toggle="modal"]').on("click", function () {
                var t = u(this),
                    e = t.data("target"),
                    n = t.attr("href"),
                    t = t.data("tab-target"),
                    e = e ? a.find(e) : a.find(n);
                t && "#" !== t && e ? e.find('[href="' + t + '"]').tab("show") : e && ((n = e.find(".nk-nav.nav-tabs")), (t = u(n[0]).find('[data-bs-toggle="tab"]')), u(t[0]).tab("show"));
            });
        }),
        ...
        (p.Range = function (t, d) {
            ...
            u(t).each(function () {
                var t = u(this),
                    ...
                    n = { start: n, connect: a, direction: p.State.isRTL ? "rtl" : "ltr", range: { min: i, max: o }, margin: s, limit: r, step: c, orientation: l, tooltips: t },
                    a = d ? g(n, d) : n;
            ...
            document.querySelectorAll(t).forEach(function (t, e, n) {
                t.checked && t.parentNode.classList.add("checked"),
                    t.addEventListener("change", function () {
                        ...
                        "radio" == t.type &&
                        (document.querySelectorAll('input[name="' + t.name + '"]').forEach(function (t, e, n) {
            ...
            a.forEach(function (t, e, n) {
                ...
                a[e].addEventListener("click", function () {
                    ...
                    s.forEach(function (t, e, n) {
                        ...
                        ((a = "" == !s[e].value ? parseInt(s[e].value) : 0), (i = "" == !s[e].step ? parseInt(s[e].step) : 1), (o = "" == !s[e].max ? parseInt(s[e].max) : 1 / 0), (s[e].value = a + i < o + 1 ? a + i : a));
                    });
                });
            }),
                i.forEach(function (t, e, n) {
                    ...
                    i[e].addEventListener("click", function () {
                        ...
                        s.forEach(function (t, e, n) {
                            var a, i, o;
                            s[e].classList.contains("number-spinner") &&
                            ((a = "" == !s[e].value ? parseInt(s[e].value) : 0), (i = "" == !s[e].step ? parseInt(s[e].step) : 1), (o = "" == !s[e].min ? parseInt(s[e].min) : 0), (s[e].value = o - 1 < a - i ? a - i : a));
                        });
                    });
                });
        }),
        ...
        (p.Tagify = function (t, e) {
            u(t).exists() && "function" == typeof u.fn.tagify && ((e = e ? g(void 0, e) : void 0), u(t).tagify(e));
        }),
        ...
        (p.Picker.init = function () {
            p.Picker.date(".date-picker"), p.Picker.dob(".date-picker-alt"), p.Picker.time(".time-picker"), p.Picker.date(".date-picker-range", { todayHighlight: !1, autoclose: !1 });
        }),
        ...
        (p.TGL.init = function () {
            p.TGL.content(".toggle"), p.TGL.expand(".toggle-expand"), p.TGL.expand(".toggle-opt", { toggle: !1 }), p.TGL.showmenu(".nk-nav-toggle"), p.TGL.ddmenu("." + t + "-toggle", { self: t + "-toggle", child: t + "-sub" });
        }),
